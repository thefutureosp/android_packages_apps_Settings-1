...
public class QuickSettingsUtil {
    ...
    static {
        ...
        TILES.put(TILE_ROCKETLAUNCHER, new QuickSettingsUtil.TileInfo(
                TILE_ROCKETLAUNCHER, R.string.title_tile_rocket_launcher,
                "com.android.systemui:drawable/ic_home_rocket_holo_dark"));                
