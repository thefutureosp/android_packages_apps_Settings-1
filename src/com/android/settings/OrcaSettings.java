...
import com.android.settings.ThemeStatus;
...
public class PacSettings extends PreferenceActivity
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        private final ThemeStatus mThemeStatus;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (headerType) {
                ...
                case HEADER_TYPE_STATUS:
                    if (header.id == R.id.themes_settings) {
                        mThemeStatus.setTextView(holder.status_);
                    }
